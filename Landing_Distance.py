...
def LandingDistance(Wingloading):
    ...
    s_50 = Wingloading*(1 / (9.81 * epsilon_L * rho * constants.c_Lmax_Landing)) * (1.23**2 - 1.08**2) + constants.h_50 / epsilon_L
    #print('s_50: ',s_50)

    s_R = (-Wingloading*1.08*1.08) / (rho * constants.c_Lmax_Landing * constants.b_M)
    #print('s_R: ',s_R)
